...
class MenuObject(pygame.sprite.Sprite):
    def __init__(self, menu, unit_id, title, subtitle, w, h, img_src1,img_src2=None,img_src3=None):
        ...
        if img_src2 is not None:
            self.is_top_group = True
        else:
            self.is_top_group = True
        self.img = self.image
        self.img_pos = (0,0)
        try:
            ...
            if self.is_top_group:
                self.img2 = pygame.image.load(os.path.join('res', 'icons', img_src2)).convert()
                self.img3 = pygame.image.load(os.path.join('res', 'icons', img_src3)).convert()
...
class MenuCategoryGroup(MenuObject):
    def __init__(self, menu, unit_id, title, subtitle, w, h, img_src1,img_src2=None,img_src3=None):
        MenuObject.__init__(self,menu, unit_id, title, subtitle, w, h, img_src1,img_src2,img_src3)
        self.selected = False
        self.categories = []
        self.initial_h = h
    ...
    def hide_icons(self):
        ...
        self.rect = self.image.get_rect()
        self.menu.mainloop.redraw_needed[2] = True
        #self.menu.scroll_menu(direction = -1, pane = 0)
        #self.menu.scroll_menu(direction = 1, pane = 0)
        self.menu.scroll_l = 0#self.rect.topleft[0] #self.scroll_l - self.scroll_step * direction
        self.menu.tab_l_scroll = 0#self.rect.topleft[0] #(self.scroll_l // self.scroll_step)
    ...
    def update(self):
        i = self.h - 30
        while i > 30:
            self.image.blit(self.img2, (6,i))
            i = i - 29
        self.image.blit(self.img3, (0,self.h - 40))
        self.image.blit(self.img1, (0,0))

        #TO DO
        #draw categories under each if selected
        #self.menu.update_me = True
        if self.selected:
            i = 85
            for each in self.categories:
                each.update()
                each.rect.topleft = (15,i)
                self.image.blit(each.image, (15,i))
                i = i + each.rect.h + self.menu.y_margin

class MenuCategoryItem(MenuObject):
...
class MenuItem2(MenuObject):
    def __init__(self, dbgameid, item_id, cat_id, title, subtitle, constructor, icon_size, img_src, variant = 0, age_group = 0):
        MenuObject.__init__(item_id, title, subtitle, icon_size, icon_size, img_src)
...
class Menu:
    ...
    def handle_pass_on(self):
        pos = [event.pos[0],event.pos[1]]
        sub_category_found = False
        #TO DO
        #go over sub categories if clicked on one of them change the above to True
                    ...
                    if self.y_margin+self.l.misio_pos[3] < pos[1] < self.game_h+self.l.misio_pos[3]:
                        ...
                        if self.rswipe_mouse_dn == self.rswipe_mouse_up and not self.rswiped:
                            ...
                            if self.mainloop.lang.lang[0:2] != "en":
                                ...
                                if n in self.en_list and not (n == "082" and self.game_variant > 11):
    ...
    def add_top_category(self,top_id,title,subtitle,img_src1,img_src2,img_src3):#105
        new_top_category = MenuCategoryGroup(self,top_id, title, subtitle, 80, self.initial_cat_h, img_src1,img_src2,img_src3)
    ...
    def add_top_categories(self):
        self.add_top_category(1,"English","sub 1","ico_t_02.png","red_bg.png","ico_tb_02.png")
        self.add_top_category(2,"Maths","sub 2","ico_t_03.png","red_bg.png","ico_tb_02.png")
        self.add_top_category(3,"Games","sub 3","ico_t_04.png","red_bg.png","ico_tb_02.png")
        self.add_top_category(4,"Multiplayer","sub 4","ico_t_02.png","red_bg.png","ico_tb_02.png")
        #self.add_top_category(4,"title5","sub 5","ico_t_03.png","red_bg.png","ico_tb_02.png")
    ...
    def add_categories(self):
        ...
        self.add_category(1,self.lang.d["Discover Letters"],"","ico_c_01.png")
        #if self.mainloop.lang.lang == "en_GB":
        #    self.add_category("Phonics","","ico_c_12.png")

        if  self.mainloop.lang.lang[0:2] not in ["ar","he"]:
            self.add_category(1,self.lang.d["Learn Words"],"","ico_c_02.png")

        if self.mainloop.lang.lang[0:2] != "en":
            self.add_category(1,self.lang.d["English"],"","ico_c_12.png")
        self.add_category(2,self.lang.d["Maths"],self.lang.d["Numbers & Basic Operations"],"ico_c_03a.png")
        self.add_category(2,self.lang.d["Maths"],self.lang.d["Basic Operations - exercises"],"ico_c_03.png")
        self.add_category(2,"Speedy Mathematician","","ico_c_03.png")

        self.add_category(2,self.lang.d["Maths"],self.lang.d["Sorting and Comparing"],"ico_c_04.png")
        self.add_category(2,self.lang.d["Working with large numbers"],"","ico_c_11.png")
        self.add_category(2,self.lang.d["Geometry"],"","ico_c_05.png")
        self.add_category(2,self.lang.d["Time"],"","ico_c_10.png")
        self.add_category(3,self.lang.d["Art"],"","ico_c_06.png")
        self.add_category(3,self.lang.d["Memory"],"","ico_c_07.png")
        self.add_category(3,self.lang.d["Games & Mazes"],"","ico_c_08.png")
        self.add_category(4,self.lang.d["Multiplayer"],"","ico_c_09.png")

        #TO DO: Update cat_h to fit all icons including the Group wrappers
        #self.cat_h = len(self.categories)*(self.cat_icon_size+self.y_margin)
        #self.cat_h = len(self.categories)*(self.cat_icon_size+self.y_margin) + len(self.top_categories)*105
    ...
    def add_games(self):
        ...
        self.add_game(12,c_id,game047.Board,self.lang.d["Sorting Letters"],self.lang.d["Lowercase Letters"],"ico_g_0105.png",variant=0)
        if self.lang.has_uc:
            self.add_game(13,c_id,game047.Board,self.lang.d["Sorting Letters"]+" ",self.lang.d["Uppercase Letters"],"ico_g_0106.png",variant=1)
        ...
        #if self.mainloop.lang.lang[0:2] == "en":
        #    c_id += 1 #Phonics
        #    self.add_game(119,c_id,game048.Board,"Synthetic Phonics","Vowels","ico_g_0108.png", variant = 0)
        #    self.add_game(119,c_id,game048.Board,"Synthetic Phonics","Consonants","ico_g_0108.png", variant = 1)
        if self.mainloop.lang.lang[0:2]  not in ["ar","he"]:
            c_id += 1
            ...
            elif self.mainloop.lang.lang[0:2] in ["pl", "uk"]:
                self.add_game(119,c_id,game082.Board,self.lang.d["Word Builder - Animals"],self.lang.d["Complete the word"],"ico_g_0203.png",variant=12)
                self.add_game(120,c_id,game082.Board,self.lang.d["Word Builder - Sports"],self.lang.d["Complete the word"],"ico_g_0204.png",variant=13)
                self.add_game(121,c_id,game082.Board,self.lang.d["Word Builder - Body"],self.lang.d["Complete the word"],"ico_g_0205.png",variant=14)
                self.add_game(122,c_id,game082.Board,self.lang.d["Word Builder - People"],self.lang.d["Complete the word"],"ico_g_0206.png",variant=15)
                self.add_game(123,c_id,game082.Board,self.lang.d["Word Builder - Actions"],self.lang.d["Complete the word"],"ico_g_0209.png",variant=16)
                self.add_game(124,c_id,game082.Board,self.lang.d["Word Builder - Constructions"],self.lang.d["Complete the word"],"ico_g_0210.png",variant=17)
                self.add_game(125,c_id,game082.Board,self.lang.d["Word Builder - Nature"],self.lang.d["Complete the word"],"ico_g_0211.png",variant=18)
                self.add_game(126,c_id,game082.Board,self.lang.d["Word Builder - Jobs"],self.lang.d["Complete the word"],"ico_g_0212.png",variant=19)
                self.add_game(127,c_id,game082.Board,self.lang.d["Word Builder - Clothes and Accessories"],self.lang.d["Complete the word"],"ico_g_0208.png",variant=20)
                self.add_game(128,c_id,game082.Board,self.lang.d["Word Builder - Fruits and Vegetables"],self.lang.d["Complete the word"],"ico_g_0213.png",variant=21)
                self.add_game(129,c_id,game082.Board,self.lang.d["Word Builder - Transport"],self.lang.d["Complete the word"],"ico_g_0214.png",variant=22)
                self.add_game(130,c_id,game082.Board,self.lang.d["Word Builder - Food"],self.lang.d["Complete the word"],"ico_g_0207.png",variant=23)
        ...
        c_id += 1
        self.add_game(131,c_id,game083.Board,self.lang.d["Basic Operations"]+" 3",self.lang.d["Addition"],"ico_g_0319.png",variant=0)
        self.add_game(132,c_id,game083.Board,self.lang.d["Basic Operations"]+" 3",self.lang.d["Subtraction"],"ico_g_0320.png",variant=1)
        self.add_game(133,c_id,game083.Board,self.lang.d["Basic Operations"]+" 3",self.lang.d["Multiplication"],"ico_g_0321.png",variant=2)
        self.add_game(134,c_id,game083.Board,self.lang.d["Basic Operations"]+" 3",self.lang.d["Division"],"ico_g_0322.png",variant=3)
        ...
        if self.mainloop.lang.lang == 'ca':
            ...
            self.add_game(135,c_id,game081.Board,self.lang.d["Clock0"], self.lang.d["Play_w_clock"],"ico_g_1000.png")
    ...
    def draw_menu(self,menu,menu_l,menu_r,l):
        ...
        pygame.draw.line(menu_l,cl.white,[l.menu_l_w-1,0],[l.menu_l_w-1,l.screen_h],1)
        ...
        for each_item in self.top_categories:
            each_item.rect.topleft = [x, y]
            #if each_item.h == 77:
            #    y += each_item.h - 25 + self.y_margin
            #else:
