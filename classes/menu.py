...
class Menu:
    ...
    def add_games(self):
        ...
        if self.mainloop.lang.lang[0:2] == "en":
            ...
            #self.add_game(6,c_id, 0, 7, game068.Board,self.lang.d["Learn to Write"],self.lang.d["Trace Letters"],"ico_g_0109.png")
            #self.add_game(7,c_id, 0, 7, game010.Board,self.lang.d["Learn to Write"],self.lang.d["Trace Letters"],"ico_g_0110.png")
        """
        if self.mainloop.lang.lang == 'ru':
            self.add_game(8,c_id, 0, 7, game022.Board,self.lang.d["Learn to Write"],self.lang.d["local_kbrd"],"ico_g_0111.png")
        if self.mainloop.lang.lang == 'el':
            self.add_game(9,c_id, 0, 7, game067.Board,self.lang.d["Learn to Write"],self.lang.d["local_kbrd"],"ico_g_0112.png")
        """
        ...
        if self.mainloop.lang.lang in ["en_GB","en_US","pl","ru","uk"] and self.mainloop.fs_size[1] > 440:
            ...
            if self.mainloop.lang.lang == 'el':
                self.add_game(15,c_id, 0, 7, game077.Board,self.lang.d["Keyboard Skills"] + " - Ελληνικά",self.lang.d["Touch Typing"],"ico_g_0107.png")
        ...
        if self.mainloop.lang.lang[0:2]  not in ["ar","he"]:
            ...
            if self.mainloop.lang.lang[0:2] in ["en", "pl", "uk", "ru"]:
