...
d["time_string_1_59_past_mh"] = "" #if you never use the to the hour form leave the above fields blank and only fill this one (or th hm version)
d["time_string_1_59_past_hm"] = "%s and %s" #if you never use the to the hour form leave the above fields blank and only fill this one (or th mh version)

d["time_string_half_to"] = "" #ie. in languages using this form, ie. half to four
d["time_string_half_past"] = "half past %s" #ie. half past three
d["time_string_q_to"] = ""
d["time_string_3q_past"] = "3 quarters past %s" #if you don't use quarter to but rather past use this one to either say it's 3 quarters past or 45 past
d["time_string_q_past"] = "quarter past %s"
d["time_string_full"] = "%s o'clock"
"""
...
d["Great job!"] = ["Great job!","Perfect!","Awesome!","Fantastic job!","Well done!"]
...
#new in 0.3.2
d["TicTacToe2"] = "Noughts and Crosses 2"
d["TicTacToe3"] = "Noughts and Crosses 3"
...
"""
d["hypotenuse"] = "hypotenuse" #przeciwprostokątna
d["cathetus"] = "cathetus" #przyprostokątna #leg / periphrasis
d["catheti"] = "catheti" #przyprostokątne #plular 
"""
...
d["DIY"] = "Do it yourself"# -*- coding: utf-8 -*-
d["Ratio"] = "Ratio"
