...
#word lists
shape_names = ["Equilateral Triangle", "Isosceles Triangle", "Obtuse Triangle", "Right Triangle", "Acute Triangle", "Square", "Rectangle", "Trapezium", "Isosceles Trapezium", "Rhombus", "Parallelogram", "Pentagon", "Hexagon", "Circle", "Ellipse"]
...
d["time_string_one_to"] = "one minute to %s"
...
d["time_string_half_past"] = "half past %s" #ie. half past three
...
#fruits = ["green apples", "red apples", "strawberries", "pears", "oranges", "onions", "tomatoes", "lemons", "cherries", "peppers", "carrots", "bananas", "watermelons"]

#google translated fruit names, are they ok?
fruit = ["grüner Apfel", "roten Apfel", "Erdbeere", "Birne", "Orange", "Zwiebel", "Tomate", "Zitrone", "Kirsche", "Pfeffer", "Karotte", "Banane","Wassermelone"]
fruits_1 = ["grünen Äpfeln", "rote Äpfeln", "Erdbeeren", "Birnen", "Orangen", "Zwiebeln", "Tomaten", "Zitronen", "Kirschen", "Paprika", "Karotten", "Bananen","Wassermelonen"]
fruits_2 = []
...
d["Paint"] = "Paint"
d["Colour Matching"] = "Colour Matching"
d["label the colours"] = "label the colours"
...
d["Great job!"] = ["Great job!","Perfect!","Awesome!","Fantastic job!","Super!","Well done!"]
...
d["Your Alphabet"] = "German Alphabet"
...
d["trapezium"] = "Trapezium"
d["u_trapezium"] = "Trapezium"
d["triangle"] = "Triangle"
