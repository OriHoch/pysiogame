...
class I18n():
    ...
    def translate(self):
        ...
        self.b["allow adding new users on login screen"] = _("allow adding new users on login screen")
        ...
        self.d["Find and separate"] = _("Find and separate the Even Numbers form the Odd Numbers in the above series.")
        ...
        self.d["a4a_animals"] = [_("cow"), _("turkey"), _("shrimp"), _("wolf"), _("panther"), _("panda"), _("magpie"), _("clam"), _("pony"), _("mouse"), _("pug"), _("koala"), _("frog"), _("ladybug"), _("gorilla"), _("llama"), _("vulture"), _("hamster"), _("bird"), _("starfish"), _("crow"), _("parakeet"), _("caterpillar"), _("tiger"), _("hummingbird"), _("piranha"), _("pig"), _("scorpion"), _("fox"), _("leopard"), _("iguana"), _("dolphin"), _("bat"), _("chick"), _("crab"), _("hen"), _("wasp"), _("chameleon"), _("whale"), _("hedgehog"), _("fawn"), _("moose"), _("bee"), _("viper"), _("shrike"), _("donkey"), _("guinea_pig"), _("sloth"), _("horse"), _("penguin"), _("otter"), _("bear"), _("zebra"), _("ostrich"), _("camel"), _("antelope"), _("lemur"), _("pigeon"), _("lama"), _("mole"), _("ray"), _("ram"), _("skunk"), _("jellyfish"), _("sheep"), _("shark"), _("kitten"), _("deer"), _("snail"), _("flamingo"), _("rabbit"), _("oyster"), _("beaver"), _("sparrow"), _("dove"), _("eagle"), _("beetle"), _("hippopotamus"), _("owl"), _("cobra"), _("salamander"), _("goose"), _("kangaroo"), _("dragonfly"), _("toad"), _("pelican"), _("squid"), _("lion_cub"), _("jaguar"), _("duck"), _("lizard"), _("rhinoceros"), _("hyena"), _("ox"), _("peacock"), _("parrot"), _("elk"), _("alligator"), _("ant"), _("goat"), _("baby_rabbit"), _("lion"), _("squirrel"), _("opossum"), _("chimp"), _("doe"), _("gopher"), _("elephant"), _("giraffe"), _("spider"), _("puppy"), _("jay"), _("seal"), _("rooster"), _("turtle"), _("bull"), _("cat"), _("lamb"), _("rat"), _("slug"), _("buffalo"), _("blackbird"), _("swan"), _("lobster"), _("dog"), _("mosquito"), _("snake"), _("chicken"), _("anteater")]
        self.d["a4a_sport"] = [_("judo"), _("pool"), _("ride"), _("stretch"), _("helmet"), _("ice_skating"), _("walk"), _("ran"), _("run"), _("swim"), _("hop"), _("hike"), _("boxing"), _("hockey"), _("race"), _("throw"), _("skate"), _("win"), _("squat"), _("ski"), _("golf"), _("whistle"), _("torch"), _("sailing"), _("stand"), _("tennis"), _("jump"), _("rowing"), _("jog"), _("rope")]
        self.d["a4a_body"] = [_("teeth"), _("cheek"), _("ankle"), _("knee"), _("toe"), _("muscle"), _("mouth"), _("feet"), _("hand"), _("elbow"), _("hair"), _("eyelash"), _("beard"), _("belly_button"), _("thumb"), _("breast"), _("nostril"), _("nose"), _("hip"), _("arm"), _("eyebrow"), _("fist"), _("neck"), _("wrist"), _("throat"), _("eye"), _("leg"), _("spine"), _("ear"), _("finger"), _("foot"), _("braid"), _("face"), _("back"), _("chin"), _("bottom"), _("thigh"), _("belly")]
        self.d["a4a_people"] = [_("girl"), _("male"), _("son"), _("mates"), _("friends"), _("baby"), _("child"), _("dad"), _("mom"), _("twin_boys"), _("brothers"), _("man"), _("mother"), _("grandfather"), _("family"), _("female"), _("wife"), _("husband"), _("bride"), _("madam"), _("grandmother"), _("couple"), _("lad"), _("twin_girls"), _("tribe"), _("boy"), _("sisters"), _("woman"), _("lady")]
        self.d["a4a_food"] = [_("candy"), _("sausage"), _("hamburger"), _("steak"), _("fudge"), _("doughnut"), _("coconut"), _("rice"), _("ice_cream"), _("jelly"), _("yogurt"), _("dessert"), _("pretzel"), _("peanut"), _("jam"), _("feast"), _("cookie"), _("bacon"), _("spice"), _("coffee"), _("pie"), _("lemonade"), _("chocolate"), _("water_bottle"), _("lunch"), _("ice"), _("sugar"), _("sauce"), _("soup"), _("juice"), _("fries"), _("cake"), _("mashed_potatoes"), _("tea"), _("bun"), _("cheese"), _("beef"), _("sandwich"), _("slice"), _("sprinkle"), _("pizza"), _("flour"), _("gum"), _("spaghetti"), _("roast"), _("drink"), _("stew"), _("spread"), _("meat"), _("milk"), _("meal"), _("corn"), _("bread"), _("walnut"), _("egg"), _("hot_dog"), _("ham")]
        self.d["a4a_clothes_n_accessories"] = [_("jewelry"), _("sock"), _("jacket"), _("heel"), _("smock"), _("shorts"), _("pocket"), _("necklace"), _("sweatshirt"), _("uniform"), _("raincoat"), _("trousers"), _("sunglasses"), _("coat"), _("pullover"), _("shirt"), _("sandals"), _("suit"), _("pajamas"), _("skirt"), _("zip"), _("shoes"), _("jewel"), _("tie"), _("slippers"), _("gloves"), _("hat"), _("sleeve"), _("cap"), _("swimming_suit"), _("sneaker"), _("vest"), _("glasses"), _("shoelace"), _("patch"), _("scarf"), _("shoe"), _("button"), _("dress"), _("sash"), _("shoe_sole"), _("robe"), _("pants"), _("kimono"), _("overalls")]
