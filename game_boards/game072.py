    ...
    def create_game_objects(self, level = 1):        
        ...
        for i in range(self.n1sl):
            if i > 0:
                ...
                self.board.add_unit(xp[1]-r_offset,yp[1],2,2,classes.board.Letter,"",white,"",21)
                ...
                nbe[i] = int(self.n1s[i])
            res[i] = nbr[i] / self.n2
            self.board.add_unit(xp[0]-r_offset,yp[0],2,2,classes.board.Letter,"",white,"",21)
            ...
            for j in range(mplsl):
                self.board.add_unit(xp[2]-mplsl*2 + j*2-r_offset,yp[2],2,2,classes.board.Letter,"",white,"",21)
            ...
            for j in range(subsl):
                self.board.add_unit(xp[3]-subsl*2 + j*2-r_offset,yp[3],2,2,classes.board.Letter,"",white,"",21)
