...
class Board(gd.BoardGame):
    ...
    def create_game_objects(self, level = 1):
        ...
        self.mylaby = classes.laby.laby(data[0],data[1],0,0,scale)
        self.mylaby.generate_laby()
        
        self.board.add_unit(0,0,1,1,classes.board.ImgShip,"",((255,255,255)),"sheep.png")
        self.person = self.board.ships[0]
        self.person.audible = True
        self.person.draggable = False
        self.board.add_door(data[0]-1,data[1]-1,1,1,classes.board.Door,"",((255,255,255)),"sheep_herd.png")
