...
class Board(gd.BoardGame):
    ...
    def create_game_objects(self, level = 1):        
        ...
        #question
        self.board.add_unit(1,0,data[0]-3-(max(self.n1sl,self.n2sl))*3 ,3,classes.board.Label,question,white,"",21)
        self.board.units[-1].align = 1
        
        #borrow 1
        for i in range(self.n1sl - 1):
            self.board.add_unit(data[0]-6-i*3,0,1,1,classes.board.Label,"-",white,"",0)
            self.board.add_unit(data[0]-5-i*3,0,1,1,classes.board.Letter,"",white,"",1)
        ...
        #add 10
        for i in range(self.n1sl - 1):
            self.board.add_unit(data[0]-3-i*3,1,1,1,classes.board.Label,"+",white,"",0)
            self.board.add_unit(data[0]-2-i*3,1,1,1,classes.board.Letter,"",white,"",1)
            self.carry10l.append(self.board.ships[-1])
            self.carry10l[-1].set_outline(self.grey, 2)
            self.carry10l[-1].pos_id = i
            self.board.units[-1].align = 2
            
        self.board.add_unit(data[0]-2-self.n1sl*3,0,2,1,classes.board.Label,"-1",white,"",0)
        self.board.add_unit(data[0]-2-self.n1sl*3,1,2,1,classes.board.Label,"+10",white,"",0)
        ...
        self.board.add_unit(0,11,data[0]-self.sumn1n2sl*3-3,2,classes.board.Label,"",white,"",22)
