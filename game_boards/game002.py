...
class Board(gd.BoardGame):
    ...
    def create_game_objects(self, level = 1):        
        ...
        top += 1
        self.board.add_unit(0,7,3,1,classes.board.Label,["Portuguese","Português"],color2,"",6)
        self.board.add_unit(3,7,data[0]-3,1,classes.board.Label,"Américo Monteiro",color2,"",6)
        top += 1
