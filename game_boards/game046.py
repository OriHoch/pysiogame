...
class Board(gd.BoardGame):
    ...
    def create_game_objects(self, level = 1):
        ...
        if self.mainloop.m.game_variant == 0:
            if self.level.lvl == 1:
                data = [11,8,1,5,5,3,"fr_apple2.png","n",0]
            elif self.level.lvl == 2:
                data = [11,8,1,6,6,2,"fr_apple1.png","n",0]
            elif self.level.lvl == 3:
                data = [11,8,2,6,6,3,"fr_pear.png","n",0]
            ...
            if self.level.lvl == 1:
                ...
                data = [11,8,1,7,7,2,"fr_wmelon.png","+",2]
            elif self.level.lvl == 3:
                data = [11,8,1,8,8,2,"fr_lemon.png","+",2]
            elif self.level.lvl == 4:
            ...
            if self.level.lvl == 1:
                ...
                data = [11,8,2,7,7,2,"fr_pepper.png","-",2]
            elif self.level.lvl == 3:
                data = [11,8,2,8,8,2,"fr_carrot.png","-",2]
            elif self.level.lvl == 4:
