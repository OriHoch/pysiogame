...
class Board(gd.BoardGame):
    ...
    def create_game_objects(self, level = 1):
        ...
        self.board.add_unit(0,4,2,2,classes.board.ImgShip,"",white,"c_tria.png",0)
        self.tria_btn = self.board.ships[-1]
        
        self.board.add_unit(0,6,2,2,classes.board.ImgShip,"",white,"c_circle.png",0)
